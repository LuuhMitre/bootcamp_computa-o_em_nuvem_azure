...
- Clique em **CRIAR UM RECURSO**:  
  <img src="imagens/criar-recurso.jpg" alt="Criar recurso" width="800"/>

- Clique em **MÁQUINA VIRTUAL**:  
  <img src="imagens/criar-vm.jpg" alt="Máquina virtual" width="800"/>

- Preencha a seção **BÁSICO** de acordo com as características necessárias para a máquina virtual:  
  <img src="imagens/criar-vm-basico1.jpg" alt="Recursos básicos" width="800"/>

- Em seguida, clique em **REVISAR + CRIAR**:  
  <img src="imagens/criar-vm-basico2.jpg" alt="Revisar e criar" width="800"/>
